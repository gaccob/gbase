...
int32_t curl_client_init_get_req(struct curl_client_t*, const char* req,
                                 CURL_CALLBACK cb, void* args,
                                 const char* cookie);
int32_t curl_client_init_post_req(struct curl_client_t*, const char* req,
                                  const char* post, size_t post_size,
                                  CURL_CALLBACK cb, void* args,
                                  const char* cookie);
void curl_client_finish_req(struct curl_client_t*);
...
CURLcode curl_client_err_code(struct curl_client_t*);
void curl_client_set_err_code(struct curl_client_t*, CURLcode);
const char* curl_client_err_str(struct curl_client_t*);
