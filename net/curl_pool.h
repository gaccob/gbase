...
struct curl_pool_t* curl_pool_create();
void curl_pool_release(struct curl_pool_t*);

int32_t curl_pool_add_get(struct curl_pool_t* cp, const char* req,
                          CURL_CALLBACK cb, void* args,
                          const char* cookie);
int32_t curl_pool_add_post(struct curl_pool_t* cp, const char* req,
